...
import { FaUser, FaAddressCard, FaShoppingBag, FaCog, FaLock, FaBell, FaTrash, FaShieldAlt, FaEye, FaEyeSlash, FaSave, FaTimes } from 'react-icons/fa';
...
export const SettingsPage = () => {
  ...
  const { alert, confirm } = useConfirmDialog();  const [activeSection, setActiveSection] = useState('password');
